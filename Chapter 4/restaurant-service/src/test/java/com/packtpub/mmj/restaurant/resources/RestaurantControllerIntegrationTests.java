...
public class RestaurantControllerIntegrationTests extends AbstractRestaurantControllerTests {
	...
	public void testGetById_NoContent() {
		...
		ResponseEntity<Map> responseE = restTemplate.exchange("http://localhost:" + port + "/v1/restaurants/99",
	...
	public void testGetByName() {
		...
		// Assumed only single instance exist for restaurant name contains word
		// "Meurice"
	...
	public void testAdd() throws JsonProcessingException {
		...
		ResponseEntity<Map> responseE = restTemplate.exchange("http://localhost:" + port + "/v1/restaurants",
		...
		Map<String, Object> response = restTemplate.getForObject("http://localhost:" + port + "/v1/restaurants/11",
				Map.class);
