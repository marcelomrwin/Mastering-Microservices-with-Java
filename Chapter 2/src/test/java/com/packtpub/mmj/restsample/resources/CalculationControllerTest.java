...
public class CalculationControllerTest {
	...
	public void testSqrtApi() {
		// API call
		Map<String, Object> response = restTemplate.getForObject("http://localhost:8080/calculation/sqrt/144",
				Map.class);
	...
	public void testSqrtApiError() {
		// API call
		Map<String, Object> response = restTemplate.getForObject("http://localhost:8080/calculation/sqrt/144a",
				Map.class);
	...
	public void testPowApi() {
		...
		Map<String, Object> response = restTemplate
				.getForObject("http://localhost:8080/calculation/power?base=2&exponent=4", Map.class);
	...
	public void testPowApiError() {
		...
		// Invoking the API
		Map<String, Object> response = restTemplate
				.getForObject("http://localhost:8080/calculation/power?base=2a&exponent=4", Map.class);
